        ...
        <div className='py-30 lg:py-20 px-4 md:px-5 lg:px-16 bg-linear-to-r to-teal-100 from-cyan-50 '>
            ...
            <div className='flex flex-wrap md:flex-nowrap justify-center md:gap-10 lg:gap-40 gap-0 items-center'>
                <div className='flex flex-col justify-center items-start gap-5'>
                    ...
                    <Link className='group mt-2 flex justify-center items-center gap-1  bg-linear-to-r from-teal-500 to-cyan-500 hover:to-teal-500 hover:from-cyan-500 transition-all duration-300 w-fit shadow-2xl  py-1.5 px-4 rounded-sm text-white ' href={"/allBook"}>

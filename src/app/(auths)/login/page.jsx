      ...
      <div className="max-w-xl w-full bg-white rounded-xl  ">
        ...
        <div className="p-4">
          ...
          <div className="flex items-center my-6">
            ...
            <span className="mx-4 text-xs uppercase tracking-widest text-gray-400 font-semibold">
              Or
            </span>
            <div className="flex-grow border-t border-gray-200"></div>
          </div>
          ...
          <form onSubmit={onSubmit} className="space-y-3">
            ...
            >
              ...
              <div className="relative">
                <Input
                  name="email"
                  className="w-full pl-10 pr-4 py-5 border border-gray-200 rounded-lg outline-none focus:ring-4 focus:ring-teal-500/10 focus:border-teal-500 transition-all"
